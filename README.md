...
Fine-tuning is a technique used in natural language processing (NLP) to adapt pre-trained language models to specific tasks or domains. In this part, we make a brief introduction to the fine tuning technology, and systematically introduce the fine tuning technology commonly used in LLM. At the same time, we made a summary of RLHF related technologies and collected relevant papers from 2021 to 2023. Our link [Resources](https://github.com/immc-lab/FollowGPT/blob/main/Resources/6/README.md)

### LLM Tutorial Resources and Evaluation Comparison

In this section, We've collected existing LLM tutorial resources, as well as large model evaluation comparisons. Our link [Resources](https://github.com/immc-lab/FollowGPT/blob/main/Resources/7/README.md)
...
|LLM PEFT papers|[Link](https://github.com/immc-lab/FollowGPT/tree/main/Resources/6)|
|RLHF Related Papers|[Link](https://github.com/immc-lab/FollowGPT/blob/main/Resources/6/RLHF%20Related%20Papers.md)|
